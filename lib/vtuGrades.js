...
export function calculateSGPA(subjects, scheme = '2022') {
    ...
    for (const s of subjects) {
        ...
        // User requested 20 credits per semester. If s.credits is missing or we want to force uniformity:
        // We'll treat each subject as having equal weight towards the 20-credit total.
        const cr = 20 / subjects.length;
