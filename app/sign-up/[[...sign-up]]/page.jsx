                ...
                <div style={s.backgroundMesh} />
                 <div style={s.contentWrap}>
                     <div style={s.headerText}>
                        <span style={s.tag}>New Account</span>
                        <h1 style={s.title}>Activate your profile.</h1>
                        <p style={s.subtitle}>Please sign up using your official institutional email ID (e.g. 2ab23cs001@anjuman.edu.in).</p>
                     </div>
